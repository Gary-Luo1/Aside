...
面向会自行配置 OpenAI 兼容接口的用户。单用途：网页划词后给出专业/通俗两层术语解释。
...
**简短介绍**  
选中术语，在原页旁注专业与通俗两层解释。使用你自己的 OpenAI 兼容接口。

**详细介绍**  
Aside 给经常读技术教程、并且已经有模型 API Key 的人使用。在网页里划一个词，点「解释这个词」，选区旁出现专业解释和通俗解释。请求只包含你选中的短文本，直接发往你填写的接口，插件作者不经手密钥和查询内容。每次解释由对应厂商计费。
